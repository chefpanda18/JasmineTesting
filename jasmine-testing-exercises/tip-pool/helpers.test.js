describe('utilities test (with setup and tear-down)', function() {
	...
	it('should sum total tip amount of all payments on sumPaymentsTotal()', function() {
	...
	it('should sum total bill amount of all payments on sumPaymenntTotal()', function() {
